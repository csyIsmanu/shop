...
<script type="text/javascript">
    ...
    function validateName() {
        ...
        //将内容发送给哪个url处理
        var url = "${pageContext.request.contextPath }/user/findByName.do?username=" + escape(username.value);
        ...
        xmlHttp.onreadystatechange = function () {
            ...
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                if (nameReg.test(document.getElementById('username').value) == false) {
                    document.getElementById('span1').innerText = "用户名必须3~20位字母数字下划线，且只能以字母开头";
                } else {
                    var color = "red";
                    ...
                    document.getElementById("span1").innerHTML = "<span style=color:" + color + ">" + message + "</span>";
                }
            }
        };
        xmlHttp.send(null);
...
<div class="container register">
    <div class="span24">
        <div class="wrap">
            ...
            <form id="registerForm" method="post" novalidate="novalidate" action="/user/save.do"
                  onsubmit="return checkForm();">
                <table>
                    <tbody>
                    <tr>
                        <p align="center" style="font-size: 20px"><strong><font color="red">${error}</font></strong></p>
                    </tr>
                    <tr>
                        <th>
										...
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha"
                                                   maxlength="4" autocomplete="off">
                                                                                         <img src="${pageContext.request.contextPath}/ValidationCode"
                                                                                              onclick="change()"
                                                                                              id="checkImg"
                                                                                              class="captchaImage"
                                                                                              title="点击更换验证码">
