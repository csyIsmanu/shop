...
<HTML>
	...
	<body>
		<form  action="/admin/updateProduct.do" method="post" enctype="multipart/form-data">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="categorySecond.csid">
							<c:forEach var="cs" items="${csList}">
								<option value="${cs.csid}" <c:if test="${product.categorySecond.csid ==cs.csid}">selected</c:if>>${cs.csname}</option>
							</c:forEach>
						</select>
					</td>
